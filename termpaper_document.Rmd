...
For the individual players, the player’s name and total prize money won in eSports competition for the respective year were collected. For each year, collection was restricted to the best 100 players. This decision was made due to the complexity of data collection unreasonably increasing while trying to get data for players out of the top 100 players by the website’s structure. Additionally, although the distribution of won prize money by players can be expected to be highly skewed with the best players earning the most, the distribution should not affect the development of prize money overall with the best players per year included. After collecting data for the years 2018 to 1998, with 2019 being left out for not being completed as of the time of the writing of this paper, prize money by all players won was summed up by the respective year. Subsequently, Pearson’s r was calculated to find out the relation of prize money won and the year. A Pearson's correlation test found a correlation of amount in won prize money in $ and the year of r= .81 for the top 100 players in each year (Figure 6). Although limiting the players to 100 in each year, the positive strong correlation indicates that a strong increase of prize money won with continuing years. A visual check of boxplots on won prize money by year as well as means over years provided that there was an overall increase in won prize money at least in the top 100 players and no centralization on only a elite group. This at least is an argument against a strong left skewed distribution of won prize money with some deviation in prize money distribution existing. As a second check, the amount of prize money available in events and won by teams will be looked at in the subsequent sections.
...
The strong correlation between prize money won by players and year is replicated with the prize money offered in tournaments (Figure 7) with a correlation of r= .77. Visual checking of boxplots and means of prize money offered by eSpport events over years provided that there as an increase of medium offered prize money over years. Subsequently, while strong outliers were detectable, the increase in offered prize money did not concentrate solely on one or two special events but included several. eSport events in total increased their prize money pool over the year. Additionally, the number of eSport events taking place increased (Figure 8) with a correlation of r= .87 to the years. This finding is especially interesting when considering business opportunities that become more widely available. With this setup, actors interested in taking a business opportunity in eSports are arguably provided with a chance since they have more possibilities of events to choose from. The final assessment for this paper's topic of emergence of organization will lay with the teams. It will be identified whether teams cease the opportunity by increasing in number and won prize money over time or whether individual players won prize money outside of teams.
